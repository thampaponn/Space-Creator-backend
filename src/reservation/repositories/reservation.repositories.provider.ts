    ...
    return [
        {
            ...
            useFactory: async (dependenciesProvider: ReservationRepoDependenciesProvider) =>
...
async function provideReservationRepositoryFactory(dependenciesProvider: ReservationRepoDependenciesProvider,) {
